...
} from "@/lib/schemas/comprobante.schema";
...
export function InvoiceForm() {
  ...
  const methods = useForm<ComprobanteFormData>({
  ...
  const isNota = ["07", "08", "Nota de Crédito", "Nota de Débito"].includes(
    docValue,
  );
  ...
  const emitirDocumento = async (values: ComprobanteFormData) => {
    ...
    try {
      ...
      console.log(
        "[InvoiceForm] Respuesta /tramas/generar ->",
        generarResponse.data,
      );
      ...
      console.error(
        "[InvoiceForm] Error al emitir/descargar trama ->",
        error,
      );
   ...
   */
  const generarXml = async (values: ComprobanteFormData) => {
    ...
    <Form {...methods}>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 pb-24">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Guía de remisión y documentos adicionales (opcional)
                    </p>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  onClick={() =>
                    methods.handleSubmit(generarXml, handleInvalidSubmit)()
                  }
                  disabled={isGeneratingTxt || isGeneratingXml}
                >
                  {isGeneratingXml ? (
        ...
        <EmitDocumentDialog
          ...
          documentType="sales"
          onEmit={() => {
            void methods.handleSubmit(emitirDocumento, handleInvalidSubmit)();
          }}
        />
      </div>
    </Form>
