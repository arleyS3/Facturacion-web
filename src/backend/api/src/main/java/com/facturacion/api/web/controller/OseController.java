...
/**
 * Controlador para enviar XML UBL 2.1 al OSE (Operador de Servicios
 * Electr&oacute;nicos).
 * <p>
...
public class OseController {
    ...
    @Operation(summary = "Enviar XML al OSE", description = "Recibe un archivo XML UBL 2.1 y lo envía al OSE para su validación.")
    ...
    public Map<String, Object> enviarXml(@RequestParam("archivo") MultipartFile archivo) {
        try {
            ...
            // Log para debuggera el contenido que se envia
            log.info("XML a enviar: {}", xmlContent);
